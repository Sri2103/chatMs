...
var file_protos_user_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x4d, 0x0a, 0x13, 0x41, 0x75, 0x74,
	...
	0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x5d, 0x0a, 0x11, 0x55, 0x70, 0x64,
	...
	0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x2e, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61,
...
var file_protos_user_proto_depIdxs = []int32{
	...
	2, // 1: user.UserService.GetUserDetails:input_type -> user.GetUserRequest
	4, // 2: user.UserService.UpdateUserDetails:input_type -> user.UpdateUserRequest
	1, // 3: user.UserService.AuthenticateUser:output_type -> user.AuthenticateResponse
	3, // 4: user.UserService.GetUserDetails:output_type -> user.GetUserResponse
	5, // 5: user.UserService.UpdateUserDetails:output_type -> user.UpdateUserResponse
